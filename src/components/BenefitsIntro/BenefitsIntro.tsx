      ...
      <LayoutWrapper>
        <div className={styles.content}>
          ...
          <p className={styles.copy}>
            ...
            in profitability for your rental home. The secret? Tapping into the
            benefits that come with owning your digital platform. In an era
            where every penny counts, a vacation rental direct website might be
            the edge you need.
          </p>
        </div>
      </LayoutWrapper>
